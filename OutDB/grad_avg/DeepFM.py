...
class DeepFM(BaseEstimator, TransformerMixin):
    def __init__(self, feature_size, field_size,
                 ...
                 use_fm=True, use_deep=True, average_gradients=10,
    ...
    def setup_train(self, average_gradients):
    ...
    def fit(self, Xi_train, Xv_train, y_train,
        ...
        for epoch in range(self.epoch):
            ...
            for i in range(total_batch):
                Xi_batch, Xv_batch, y_batch = self.get_batch(Xi_train, Xv_train, y_train, self.batch_size, i)  #  get batch data

                self.fit_on_batch(Xi_batch, Xv_batch, y_batch)  # fit on batch
